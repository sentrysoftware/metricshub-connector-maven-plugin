 ...
 */
public class WbemCriterion extends AbstractWqlCriterion {

	private static final String WBEM_TYPE = "WBEM";

	/**
	 * Constructs WbemCriterion with the specified JSON criterion.
	 *
	 * @param criterion The JSON criterion for WBEM check.
	 */
	@Builder
	public WbemCriterion(final JsonNode criterion) {
		super(criterion);
	}
