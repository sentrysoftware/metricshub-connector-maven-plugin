 ...
 */
public class WmiCriterion extends AbstractWqlCriterion {

	private static final String WMI_TYPE = "WMI";

	/**
	 * Constructs WmiCriterion with the specified JSON criterion.
	 *
	 * @param criterion The JSON criterion for WMI check.
	 */
	@Builder
	public WmiCriterion(final JsonNode criterion) {
		super(criterion);
	}
